"""
Django settings for Aporte project.
...
SECRET_KEY = 'django-insecure-ujwe+z8j7e6_op_n0^6+4qh*t8aofqj%p-2^fiwpsr1mcv0ze^'
...
WSGI_APPLICATION = 'Aporte.wsgi.application'
